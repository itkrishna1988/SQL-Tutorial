...
-- Create LimitedIO user in the database and associate with the LimitedIO SQL Server login
...
-- See how large the table is
EXEC sp_spaceused N'dbo.TestData';

-- Get elapsed time information
...
-- Takes about 3-4 seconds with no I/O throttling
